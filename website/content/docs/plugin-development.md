...
description: An osn. plugin is a standard npm package that exports a plugin definition created with the `definePlugin()` factory function from @osndot/sdk. Plugins can register CLI commands, hook into task lifecycle events, and access a shared context.
section: Guide
order: 3
---
<div align="center">
